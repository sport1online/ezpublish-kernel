...
class RichTextTest extends AbstractParserTestCase
{
    ...
    public function testDefaultContentSettings()
    {
        ...
        $this->assertConfigResolverParameterValue(
            ...
            array(
                0 => array(
                    'path' => '%kernel.root_dir%/../vendor/sport1online/ezpublish-kernel/eZ/Publish/Core/FieldType/XmlText/Input/Resources/stylesheets/eZXml2Html5_core.xsl',
                    'priority' => 0,
                ),
                1 => array(
                    'path' => '%kernel.root_dir%/../vendor/sport1online/ezpublish-kernel/eZ/Publish/Core/FieldType/XmlText/Input/Resources/stylesheets/eZXml2Html5_custom.xsl',
                    'priority' => 0,
                ),
            ),
            'ezdemo_site'
            ...
            array(
                ...
                array(
                    'fieldtypes.ezrichtext.output_custom_xsl' => array(
                        ...
                        array( 'path' => '%kernel.root_dir%/../vendor/sport1online/ezpublish-kernel/eZ/Publish/Core/FieldType/RichText/Resources/stylesheets/docbook/xhtml5/output/core.xsl', 'priority' => 0 ),
                        array( 'path' => '/foo/bar.xsl', 'priority' => 123 ),
                        array( 'path' => '/foo/custom.xsl', 'priority' => -10 ),
                        array( 'path' => '/another/custom.xsl', 'priority' => 27 ),
                    ),
            ...
            array(
                ...
                array(
                    'fieldtypes.ezrichtext.edit_custom_xsl' => array(
                        // Default settings will be added
                        array( 'path' => '%kernel.root_dir%/../vendor/sport1online/ezpublish-kernel/eZ/Publish/Core/FieldType/RichText/Resources/stylesheets/docbook/xhtml5/edit/core.xsl', 'priority' => 0 ),
                        array( 'path' => '/foo/bar.xsl', 'priority' => 123 ),
                        array( 'path' => '/foo/custom.xsl', 'priority' => -10 ),
                        array( 'path' => '/another/custom.xsl', 'priority' => 27 ),
                    ),
